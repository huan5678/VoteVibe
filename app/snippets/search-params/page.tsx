    ...
    <div className="prose prose-sm prose-invert max-w-none">
      ...
      <div className="mt-12 space-y-12">
        <div className="space-y-4">
          ...
          <Link href="https://beta.nextjs.org/docs/api-reference/use-search-params">Docs</Link>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Link href="https://beta.nextjs.org/docs/api-reference/file-conventions/page">Docs</Link>
        </div>
      </div>
    </div>
  );
